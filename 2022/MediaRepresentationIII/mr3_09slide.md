...
シラバス作成時にはこの項目明示的にやるつもりはなかったのですが、他の先生の要望があって取り入れました。

今回シェイプレイヤーかなり調べてみましたが、いろんなことができますね。
...
について説明してきましたが、基本的にはそれを利用すればOKだと思います。
...
---
### やってみよう(時間あれば)
シェイプレイヤーの中で説明した機能を使って、なんか作ってみよう。

複数のシェイプエフェクト組み合わせると面白いのができると思う。
...
また、多分ですが、授業内では詳しく扱いませんが(来週扱うかな...)、テキストのところにある「アニメーター」も同様な機能と思われます。そちらも、試してみましょう。
