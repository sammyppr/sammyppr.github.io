...
- 改ざんする
- 盗んだ情報を悪用する
ことを「クラッキング」といい、そのような行為をする人を「クラッカー」といいます。
...
#### ファイアウォール
> 防火壁の意味で外部からの攻撃、あるいはコンピュータからの情報の流出を防ぎ、コンピュータを守る役目を果たすハードウェアまたはソフトウェアのこと
...
---
### ルータの利用
ルータ (router) は、異なるネットワークどうしをつないで道先案内人をするものです。
