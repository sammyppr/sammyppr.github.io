...
レンダープロパティの (ScreenSpaceReflections 4.2以前) Raytracing にチェックを入れる
...
- [旧バージョンから Blender 4.2 LTS への EEVEE の移行](https://wiki.blender.jp/Dev:JA/Ref/Release_Notes/4.20/eevee/eevee_migration)
- [Screen space reflections in EEVEE has been replaced by Raytracing](https://www.youtube.com/watch?v=RzE0IeV-hVc)
...
- (Added 2026/4/17 NEW) カメラアイコンをクリックして、鍵アイコンをクリックがはやい！
- Render Image
- Save
