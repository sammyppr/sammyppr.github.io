...
(2026/05/08 update)
4.2以降のBloomの方法をメディア表現VのTOPページ下に追加しました。
...
(2026/5/20 update)
Texture PaintモードでUVの島がBlenderder5系で見えなくなっています。
左パネルの右上のGeometry->Edgeを1にすることで表示されます。
...
- [800 procedural materials for Blender - Free download](https://maroc777772.gumroad.com/l/oaehcd){:target="_blank"}
