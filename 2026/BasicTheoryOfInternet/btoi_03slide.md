...
## 追加...
CPUの性能を調べるベンチマークソフトというものがあります。
- Passmark
- Cinebench

等色々ありますが、PassmarkのPerformanceTestをちょっとやってみます。
...
- Autograph(AfterEffects)

なぜか、無料で提供されています。すごい世の中になってきました。
...
## AI
### AIのOS統合
AIの進化により、AIのOS統合が模索されています。

- Windows: Microsoft 365 Copilot
- Mac: Apple Intelligence

まだ、今後どうなるかよくわかりません。バタバタしそうです。
- [OS×AI統合で明暗 – GoogleのGemini全面展開 vs MicrosoftのCopilot戦略転換](https://smart-generative-chat.com/2026/02/13/gemini-copilot-os-integration-strategy-2026/)
- [Apple Intelligenceの制度と設計思想](https://qiita.com/ts-arai/items/5cc47238124eb7a4e067)
...
と分類することができます。多くの人はクラウドAIを利用しているのではないでしょうか。クラウドAIの利用時には情報をクラウドに提供してしまうため、セキュリティ上のリスクがあることを知っておきましょう。

ローカルAIではセキュリティリスク低い反面、コンピュータのスペックが必要となります。
