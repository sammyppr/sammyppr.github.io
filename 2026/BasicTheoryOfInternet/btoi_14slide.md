...
個人的にはあまり興味はないのですが、「スライドにいらすとやを使っている」などの人には重宝すると思います。いらすとやのテイストで自動生成もできます...サービス停止してますね。

- [【2026年最新】画像生成AIおすすめ8選｜選び方と注意点](https://coopel.ai/column/post/image-generation-ai-recommended/)

- [いらすとや風のイラストを生成する「AIいらすとや」を正式リリース！無制限に生成・商用利用が可能に！](https://prtimes.jp/main/html/rd/p/000000012.000113219.html)
...
- [無料で使えるAI議事録自動作成ツール18選！無料プランの種類や選び方も解説](https://jp.plaud.ai/blogs/blog/ai-minutes-creation-tool-free)
...
- [ボイスアイソレーター どんな音声からもクリアな音声を抽出](https://elevenlabs.io/ja/voice-isolator?gad_source=1&gad_campaignid=23815375915)
...
もちろん、ChatGPT等に頼んでもある程度できると思います。

## 画像認識・物体検出
### ロトブラシ
様々なところで利用可能な画像認識技術ですが、映像を作るときのロトブラシ(物体を切り抜く)という機能にも利用されています。

- [古い...~~【After Effects】最新ロトブラシ3はすごい！機能検証！これ使う人は必見！~~](https://www.youtube.com/watch?v=XorK-9zGofo&t=360s)
- [【AfterEffects】新機能オブジェクトマットツールを使って、人物の裏にテロップを簡単に配置する方法！](https://www.youtube.com/watch?v=hOoZlOtHzA4)
...
いわゆるチャットボット系の生成AIからコマンドを叩かせて映像編集する方法も出てきています。

CLI(コマンドラインインターフェイス)というものとAIは親和性が非常に高いので興味ある人は、次の動画を見ておきましょう。

- [参考：【保存版】CLIの使い方を非エンジニア向けに解説【AIにコマンドを書いてもらう神ターミナルアプリも紹介】【Claude Code, Gemini CLIが使えるようになる】](https://www.youtube.com/watch?v=_FU3Yfizfn0)
...
- [ソニー対Suno・UdioのAI著作権訴訟が重大局面へ——タバコ訴訟で42兆円を勝ち取った大手法律事務所も参入](https://www.zaikei.co.jp/article/20260629/858942.html)
...
小学校・中学校でも「情報」を拡充するとの方針が出てますが...
- [中学「情報・技術科」授業、年70コマ　次の指導要領、小学校も拡充](https://www.asahi.com/articles/ASV773WB7V77UTIL030M.html)

国語や算数・数学は基礎力となります。この時間を削減するとか何を考えているんでしょうね？自分は反対です。
