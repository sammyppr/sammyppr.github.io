...
後にJavaという言語について触れますが、全く異なるものですので、これだけは間違えないでください。webの仕事をしていても、本当に間違える人が多いです。恥ずかしいので気をつけてください。
...
### ライブラリ
CSSにもありましたが、JavaScriptを１から全部書かなくても、便利なツールをひとまとめにした**ライブラリ**と呼ばれるものが存在しています。

無料で利用できるものも多いため、便利だな、と開発者が思うと一気に世界中に利用が広まります。前回も紹介しましたが
...
こういうことをするには、WebAssemblyが向いています。デザインツールとして有名な[Figma](https://www.figma.com/blog/webassembly-cut-figmas-load-time-by-3x/)にても利用されています。
...
- [Frontend Developer](https://roadmap.sh/frontend) [日本語解説](https://qiita.com/unotame/items/a7addb56cb95f242c9c7)
...
### バックエンドで利用される言語
- [Your Guide to the Best Backend Languages for 2026](https://talent500.com/blog/best-backend-programming-languages-2026/)
<!--
...
例えば、[Googleマップ](https://www.google.com/maps)で移動する度に新しいページがロードされたら面倒くさいですよね。このAjaxを実現するためには
...
[JavaScript FirstStep](https://sammyppr.github.io/2025/InformationDesignAppliedII/tex/JavascriptFirstStep.pdf)
