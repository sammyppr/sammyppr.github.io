...
- [【2025年11月】検索エンジンシェア率のランキングと推移（日本・世界）](https://ohdo.at21.jp/web/search-engine-share/)
...
- [【緊急】Google、情報漏洩。SEOアルゴリズム判明！？(13:23)](https://www.youtube.com/watch?v=6qUf0RdF-8A)
- [【緊急・続報！】Google、情報漏洩。SEOアルゴリズムや新事実が判明！？(13:57)](https://www.youtube.com/watch?v=wMw0dlVqmfo)
...
- [検索順位は変わらないのにアクセス減？AI検索時代の正体と対策](https://access-scope.jp/rank-same-but-traffic-down-ai-search/)

### ユーザ行動の変化
ユーザがAIの答えに満足すると、クリックをせずにHP遷移しないことを意味します。

> AIによる概要が表示される検索では、検索1位ページのクリック率が約58%低下していたと報告されています。2023年12月時点と2025年12月時点を比較したものです(引用)

検索したのにどのサイトもクリックせずに終わる状態を「ゼロクリック検索」と呼ぶ人もいます。

便利になることは素晴らしいことですが、HP運営者にとっては非常に頭の痛い問題となっています。

- AI検索最適化 AIO(AI Search / Optimization)： 生成AIの回答欄に自社サイトのコンテンツが引用されるよう対策するWebマーケティング手法。

が模索されています。

### AIO
- [AIO(AI検索最適化)とは？具体的な対策・SEOやLLMOとの違い](https://mieru-ca.com/ai-seo/aio/)

ただひとつ...マーケティング屋さんは新しい用語大好きです。
定着しない可能性もあります。
...
## SEOはもう古い？
SEO対策をすれば良いと言われてきましたが、事情がAIによって変わってきました。
