...
- [bitwarden](https://bitwarden.com/ja-jp/products/personal/)
...
情報センターに尋ねたところ、この大学のネットワークにおいて利用されるコンピュータから、特に[USBメモリがウィルスに感染している](https://www.trendmicro.com/ja_jp/security-intelligence/research-reports/threat-solution/usb-worm.html)、との報告が頻繁にあがってくるようです。
...
AI・機械学習を使った[NGAV(NextGenerationAntiVirus)](https://www.daiko-xtech.co.jp/daiko-plus/security/securitymeasures-cyberattack/)と呼ばれるものも出てきていますが、まだあまり普及してないように思えます。
...
- [iOSで｢代替アプリストア｣解禁の現実､App Storeにないアプリやポイント還元も視野に入れた新しい使い方](https://toyokeizai.net/articles/-/941095?page=2)

iOS 26.2以降のバージョンでは、App Store以外の代替アプリストアに対応しました。安全かどうか、しっかり確認しましょう。

また、WebサイトからSafari（ブラウザ）に対して攻撃することはできるため、アップデータはまめにかけましょう。
...
- [情報セキュリティ10大脅威2026](https://www.ipa.go.jp/security/10threats/10threats2026.html)

動画化してくれている人がいます。個人編を見てみましょう。
- [情報セキュリティ10大脅威2025 個人編 #初心者のためのセキュリティ(7:01)](https://www.youtube.com/watch?v=mO1iLuihCwg&list=PL6_lpWnlPdww3ROwUm0KMPdSLDU1-WpZN)

リストにリンクしているので、そのまま組織編もみることができます。
...
現在、2月の衆議院選挙について誹謗中傷が組織的に行われたかどうかが大きな社会問題となっています。
...
- [【SNSの誹謗中傷対策】「削除」進む？ 罰金は最大1億円…“迅速な対応”法的な義務に(3:28)](https://www.youtube.com/watch?v=Xc19T6xM-o8)
...
それとともに、SNSの情報が正しいか誤っているか判断するメディアリテラシーがさらに問われていると考えます。
...
## 番外編
### 著作権法の一部を改正する法律案が6/17に可決
- [「著作権法の一部を改正する法律案」が参議院本会議で可決され成立しました](https://www.mext.go.jp/b_menu/activity/detail/2026/20260617.html)
...
>  今回の権利の導入により、実演家等への望ましい対価還元を図り、我が国の音楽や、それを伝える実演家等の海外展開の一層の促進を図ってまいります。(以下略)
