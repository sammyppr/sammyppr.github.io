...
### コンピュータ基礎理論
これまで３回(2-4回)コンピュータの基礎(ハードウェア・ソフトウェア・仕組み)について話をしてきましたが、
...
### 脱線：規格競争
過去には様々な規格の競争が行われました。
同じことを実現するのに、技術が違うために互換性がなく、市場をとった方が衰退する、ということが行われてきました。

- ビデオテープレコーダ：VHS vs Beta
- 小型ビデオテープ：8mmビデオ vs VHS-C
- デジタルビデオテープ：DV vs D-VHS
- 第3世代光ディスク：BD vs HD DVD
- メモリカード：SDカード vs メモリースティック
...
```
の略でファイルの転送に利用されています。暗号化されたSFTPですが...
