...
将来Webデベロッパーと話をする時に、仕組みをわかっていれば「こんなことできるはずだよね」みたいなやり取りが可能になると思います。
...
### DOM
HTMLはタグによって文章を構造化されます。これをブラウザに読み込むとDOM(Document Object Model)として整理されます。
CSSもこれに沿って、連鎖されていきます。

![width:700](https://storage.googleapis.com/envader-article-images/react-dom/dom-003.png)
...
### range記法
書きづらかったので最近では違う書き方も使えるようになっています。

```css
@media (375px <= width < 768px) {
  /* 375px以上768px未満の幅に対するスタイル */
}
```
より直感的に表現することが可能になっています。

### デスクトップファースト・モバイルファースト
Webデザインでは、PCから作り始める「デスクトップファースト」、モバイルから作り始める「モバイルファースト」という言葉があることは知っておいて良いでしょう。
...
- -->
- [【2025年最新版】コンテナクエリについて / メディアクエリとの違い〜文法までを紹介](https://nnc-studio.jp/plugin/2023/04/13/css-container-query/)
...
なお、JavaScriptの機能を提供するものを **JavaScriptエンジン** と呼びます。

### 実際の開発
- [【2026年1月版】世界・日本におけるブラウザシェア率ランキング](https://www.qbook.jp/column/1630.html)
...
### CSSのバージョン
CSS3というものが現在利用されていますが、これ進化し続けています。HTML Living Standardも進化し続けていましたね。
...
オフィシャルのそれぞれのページは以下にあります。
- [HTML Living Standard](https://html.spec.whatwg.org/multipage/)
- [ascading Style Sheets home page](https://www.w3.org/Style/CSS/)
...
## CSS ジェネレータ
### 全然わからん...
今日聞いただけだと、ふーーん、でも実際にどう描いていいか全くわからないみたいに感じることでしょう。

世の中には便利なツールがあり、それを利用することで、
> CSSをどこに記載すべきか？

だけわかっていれば、コピペである程度は作成することができるようになります。

### CSSジェネレータ
CSSをインタラクティブに作成する「CSSジェネレータ」と呼ばれるものがWebには多くあります。

いくつかみてみましょう。

- [WEB GENERATOR](https://web-generates.com/)
- [Front-end Tools](https://front-end-tools.com/)
- [コピペで作れる！おすすめのCSSジェネレーター・ツールまとめ](https://webdesign-trends.net/entry/13790)

## CSSライブラリ
### CSSライブラリ
Webページのデザインやレイアウトを効率的に整えるための「スタイルシートの部品集」も配布されています。

アニメーションに特化したものもあります。

- [【困ったらこれ！】CSSアニメーション制作の効率が上がる！ライブラリ・ジェネレーター集](https://kasoudesign.com/knowledge/css-animation-generator)
...
- [2026年版おすすめCSSフレームワークランキング](https://x-hours.com/articles/922)
- [CSSフレームワーク完全比較ガイド｜2026年版選び方](https://fivenine-design.com/blog/css-framework-comparison-guide-2026)
<!--
...
も人気があるようですが、凝った開発者は全く異なる設計思想を持つTailwind CSSにも注目しています。

## AIの動向
### AI
ホームページの制作自体は、AIが自動で制作できるところまで来ています。

実験してみましょう。
> 1. Gemini
> 2. Canvasを追加
> 3. 「音楽演奏ができるバーのHPを制作して」

### カスタマイズするのに
HTML,CSS,Javascriptの基本を理解していないと、AIに指示出しすることができません。実際にかけなくても、基本や用語は頭に入れておいた方が良いと思います。

- [Vibe Coding 用語集](https://vibecoding-glossary.pages.dev/)
