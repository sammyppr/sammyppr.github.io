...
- [After Effects 26.0 リリース](https://polygonote.com/2026_0122_27523/)

26.2においては、[「パラメトリックメッシュでの 3D マテリアルのディスプレイスメントサポート」](https://helpx.adobe.com/jp/after-effects/using/whats-new.html)が可能となり、単純な形状でないものも表現可能となりました。

メディア表現V(3年前期)にて、Blenderを用いた3D表現について学びますが、AfterEffectsだけでここまでできるようになったことも知っておきましょう。

---
### こんなことも！
- [The Most Cinematic After Effects Update Ever! What's New?](https://www.youtube.com/watch?v=Cy5ckmGeekY)
