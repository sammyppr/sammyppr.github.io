...
### マスク(授業後追加)
Premiereでは
- クリップを選択してからマスクツール(楕円形・長方形・パス)で形状を作成
- エフェクトコントロールの「割り当てられていないマスク」を不透明度や、エフェクトにかける

オブジェクトマスクは新しい機能ですので、13回目で説明します。

AfterEffectsでは
- レイヤーを選択
- 長方形ツール・角丸長方形ツール....またはパスで形状を作成

にて、マスクをかけられます。レイヤーを選択しないとシェイプレイヤーが作成され、シェイプが作成されます。
