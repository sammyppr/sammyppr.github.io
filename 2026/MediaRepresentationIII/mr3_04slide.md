...
エクスプレッションという数式を扱う方法もあります。(8回目に扱います)
...
それでも、AfterEffectsの根本の考え方はビットマップ、ということを知っておく必要があります。
...
3. 楕円形追加
4. 線追加 色を適当に設定
5. パスのトリミング追加(開始点 0:00 0%, 1:00 100%)
6. キーフレーム状で右クリック キーフレーム補助 イージーイーズ
7. 同じく(終了点 0:00 0%, 1:29 100 %)
...
---
### 動画
- [シェイプレイヤーで遊んでみよう](https://youtube.com/watch?v=mgApudXfHA0)
