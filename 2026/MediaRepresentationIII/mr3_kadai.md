...
---
### 最終課題について
以下の二つの課題をNASに提出してください。(smb://nas1-mc.thu.ac.jp, StudentVolume - 2026演習-メディア表現III-最終課題-学籍番号フォルダ)
最終課題の締切日は**7月末**とします。

---
#### 1. MOGRTを作成せよ。
7回目の「モーショングラフィックステンプレートの制作」を参考に**オリジナル**のMOGRTを作成せよ。AE,MOGRTの両ファイルを提出すること。

##### 注意1
モーショングラフィックステンプレートは使いまわせることがメリットです。
パラメータの設定について利用しやすいように作成しましょう。
...
映像デザイン演習にてロゴムービーの課題が出ていることから、MOGRT・レポートとしました。
