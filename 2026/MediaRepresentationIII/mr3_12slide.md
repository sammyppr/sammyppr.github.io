...
# カラーコレクション
---
### ダウンロードしよう<!-- omit in toc -->
前回いなかった人は、ダウンロードしよう

[肌色の修正ファイル](https://sammyppr.github.io/2026/MediaRepresentationIII/data/correct-skin-tones.zip)

---
### やってみよう(複数)<!-- omit in toc -->
1. 新規調整レイヤーを作成し、V3に二つのクリップにまたがるようにおく
2. 基本補正のホワイトバランスのスポイトで黒人のシャツの襟あたりをクリック
3. J.mp4を選択して、**長方形マスクツール**で黒人の額あたりに長方形を描く
4. エフェクトコントロールで**割り当てられていないマスク**の**長方形マスク**を**fx不透明度**に移動
5. プログラムウィンドウのマスクオーバーレイを「なし」にすると、マスクを表す色が消える
6. 額に合わせて、ベクトルスコープYUVが左上のラインと重なっていることを確認。
7. Emily.mp3でも同じことをしてスキントーンが正しいことを確認しよう。
8. 二つの不透明度のfxを外してマスクを外す
9. 彩度をいじると、外側に広がっていくことを確認しよう
10. ライトをいじっても、ベクトルスコープYUVの方向の分布は変わらないことに注意。輝度にしか影響しないことを確認しよう。
