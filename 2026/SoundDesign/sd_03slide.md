...
音声ファイルの可逆圧縮なものにはFLACがあります。
一般的にはそこまで利用されていませんが、ハイレゾ配信においては7割ほどが選択しています。(データ古いのしかなかった)

- [ハイレゾ音楽配信についての集計結果](https://av.watch.impress.co.jp/docs/enq/result/656389.html)
