...
受講人数が現状履修者47名です。(あれ？4年生が5名...)

506は映像デザイン演習が入っているので、コンピュータ演習室の空きを探したら606,706が空いてました。
コンピュータ演習室だと電源が各机にあります。

というわけで、申請通れば移動しようかと思います。
...
であってる学生も多いと思いますが、紙の先生でもなく、映像の先生でもなく、メインは情報担当の先生です。よろしくお願いいたいます。(ゼミでは映像の技術よりなトピックも担当はしてます)
...
ちょっと動画を見てみましょう。
[美しいグラフはシンプルに全てを伝える(5:47)](https://www.ted.com/talks/tommy_mccall_the_simple_genius_of_a_good_graphic?language=ja)
...
[あなたの(そして何十億人の)ための巨大なウェブデザインの方法(12:46)](https://www.ted.com/talks/margaret_gould_stewart_how_giant_websites_design_for_you_and_a_billion_others_too?language=ja)
...
なお、個人的には2026/9/10に発表された[iPhone Duo](https://www.apple.com/jp/iphone-duo/)により、またデザインに影響を与える気がしています。
...
コロナ禍にオンライン授業をしていた頃、いろんな先生の質問に答えていましたが、こんなものがありました。
...
## なぜ、Chrome?Brave?
- [【2025年10月調査】日本・世界のWebブラウザシェア率のランキングと推移](https://ohdo.at21.jp/web/browser-market-share/)
...
### zenkaku
全角スペース(バグの元)があると、それをわかりやすく表示してくれます。
...
大学で案内が出ているオンラインでの購入でも良いですが、どの本屋さんでも必ず置いていると思うので、本屋で買った方が送料がかかりません。


# 資格について
## Webリテラシー検定

意識高い人はインターンシップなどに行き始めて、色々進路について考えているかと思いますが、IT業界に興味ある人はいますでしょうか？
...
# Github
## 今年から新たに導入...
これまで、この内容はメディア表現VIにて説明していたのですが、
今年から、2,3年の演習ともに導入しようと思います。

ファイルのバージョン管理のシステムなのですが、バックアップにも使えます。

ちょっと設定だけ面倒くさいです。1回目のスライドでなくHPの方に説明がありますので、そちらをみてみましょう。
...
## やってみよう<!-- omit in toc -->
これ以下は、Githubやっている場合には、クローンリポジトリで終わってると思うので、「ID_01」フォルダを作成するところからやってみましょう。

- 書類フォルダ等に、「ID2006」というフォルダを作成
- VSCode起動
...
あ！フォルダ名に日本語や全角文字は禁止とします。Webサーバと相性非常に悪いからです。
英数字を主に利用するようにしましょう。
...
- <!DOCTYPE html>: HTMLで書かれていることを意味します
