...
1. Macの電源は左後ろにあります。
2. ネットワークに参加するために、共用マシンですので、「この情報を記憶」のチェックは外して「アカウント名/パスワード」を入力してOKをして下さい。manabaにアクセスするのと同じものです。
...
3. チームから「2026_夏期スクーリング_マルチメディア演習」があることを確認してください。
...
## Macについて<!-- omit in toc -->
普段Windowsを利用しているのでMacはよくわからない、と言う場合には、躊躇せずにどんどん質問してください。
...
### ニューメディア
最近では
> オールドメディアとは新聞やテレビなどの伝統的な既存メディアを指し、ニューメディアとはSNSやWebニュースなどのインターネットを基盤とした新しいメディアを指します。
...
最終的な目標を以下のように設定します。
- AdobeのIllustrator, Photoshop, Premiereを使える
- ホームページの仕組みを理解できる

※ 映像編集ソフトのPremiere Proは2025年10月28日のアップデート時にPremiereと名称変更となりました。
...
---
### 無料ソフト探し方
「Photoshop alternative 2026」「Photoshop 代替 2026」などとググるとたくさんの記事がヒットします。

さまざまなアプリケーションを無料で利用する環境が整ってきている、ということを理解しておきましょう。

また、この流れを受けて生徒・教育機関向けには無料で利用できるライセンスが用意されていることも多くなってきています。

Adobeも小中高向けの無料プラン[Adobe Express](https://www.adobe.com/jp/education/express/)を用意しています。
...
---
### Photoshopにも...
Photoshop/Premiere等にも生成AI機能がどんどん追加されています。

便利なのですが、基本を飛ばしてしまうので、本演習では基本教えません。(調べて使ってくれても問題ありません。)

最新のアップデート状況を見てみましょう。

- [【最新】Photoshop 2026の神アプデ7選！生成AI時代の新機能がすごすぎるのでレビューします](https://www.youtube.com/watch?v=ty5VFayVrHw)
...
なお、最近では「ゼロクリック検索」というものがWeb業界では問題となっています。
- [ゼロクリック検索とは？～Webサイトへの影響と対策を徹底解説～ ](https://www.ntt-ad.co.jp/column/zero_click/)
<!--
...
最近ではカメラの性能の向上により、ピクセル数が増えていて画像の解像度が汚い、ということを経験することが少なくなっています。
...
液晶ディスプレイの発達により画面の解像度自体が上がっています(iMacでは218ppi)。<!-- レスポンシブデザインにより表示されるタイミングで画像サイズ変化します。-->
...
ダウンロードして、ダウンロードフォルダの中にあるまま利用すると、次回にデータがなくなったりして困ったことになります。
...
個人的には広角・狭角と解釈した方がより正しく理解できると思います。
...
- 三角矢印のマークがついてあるスライドするボタンをスライドして、レンズを回して、使えるようにしましょう。
<!--
- 外す時にはEOSマークの上の黒いボタンを押して、左に回しましょう。
-->
望遠レンズ・マクロレンズ希望の人は一応あります。撮影に行く前に申し出てください。
...
<!-- 感染症対策として気になる人はアルコール消毒を利用してください。(SA呼んでください)-->
...
この考え方は、実際にIllustrator, Photoshopで利用できます。

その他参考HP
- [ゲーム感覚で学べる！？WEBデザイン力向上サイト](https://star-kid.co.jp/topics/note/web-design/designgamesite/)
- [ゲーム感覚で実践的なWebデザインの基礎を学習できる「Uxcel」で遊んでみた！](https://paiza.hatenablog.com/entry/2021/05/12/153000)
