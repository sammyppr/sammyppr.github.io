...
## インストールについて(2026/04 追記)
### UnrealEngine 5.7.4
- Epic Game Launcherインストール
- Unreal Engineインストール
### Xcode
- Xcodeインストール
- Xcode Settings - Components -  Metal ToolchainをGet
- Xcode でPredictive Code Completion Model も自動でダウンロード
- ターミナルで sudo xcode-select --switch /Applications/Xcode.app

MetalToolchainが増えてます。
