...
## 2回目の内容について
「紙」としましたが、18世紀くらいまでの記録媒体を扱おうと思います。
...
## 文字の誕生
コミュニケーションは身振り手振りや音声によって取られてきましたが、それを録画・録音する技術は太古には当然存在せず、**記録**されるためには先述した**絵画**の形が取られてきたが、**文字**はBC3500年頃、**シュメール文字・楔形文字**が開発されました。
...
## ペンの誕生
粘土板やパピルスに書くためには葦を削った**葦ペン**が利用された。

鳥の羽根を利用した**羽根ペン**は、5世紀以降主要な筆記具として利用された。

**ペンナイフ**は、小さなペンの意味で現在は使われているが、羽根ペンのペン先をナイフで削る必要があり、その目的に使われるナイフのことであった。

なお、penの語源はラテン語のpennaであり「羽根」を意味する。
...
- [Gutenberg Printing Press](https://www.youtube.com/watch?v=yeikqw0kyqI)
